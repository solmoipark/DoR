...
> 9. **P-IG-6 구현·검증(2026-09-03):** InverseGems `dorgems/p-ig-6-opc-minor-oxides`(`535f90e`) — pH 12.66→13.60, AFt/AFm·브루사이트·LDH 형성, 질량 수지 정상화. CH 과대는 남음(기본 OPC C3S 66 %·CSHQ Ca/Si 상한). GemsPilot 앵커 재생성 브랜치 `dorgems/p-gp-4-anchor-refresh`(`a05467b`). §12 G1-4의 앵커 수치는 두 레포 모두 갱신 필요.
